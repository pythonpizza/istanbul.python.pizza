...
The Warsaw Python Pizza Team is here to help attendees feel safe for the duration of Warsaw Python Pizza event. We value your participation. If you need to report an incident please reach out to the Team via [email](mailto:warsawpythonpizza@gmail.com?subject=%5BCode%20of%20Conduct%5D).
