...
The Python Pizza Istanbul Team is here to help attendees feel safe for the duration of Python Pizza Istanbul event. We value your participation. If you need to report an incident please reach out to the Team via <a href={`mailto:${event.contactEmail}?subject=%5BCode%20of%20Conduct%5D`}>email</a>.
