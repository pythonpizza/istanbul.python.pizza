...
{event.name} is dedicated to providing a harassment-free conference experience for everyone, regardless of gender, gender identity and expression, sexual orientation, disability, physical appearance, body size, race, age, religion or lack thereof.
...
The {event.name} Team is here to help attendees feel safe for the duration of the {event.name} event. We value your participation. If you need to report an incident please reach out to the Team via <a href={`mailto:${event.contactEmail}?subject=%5BCode%20of%20Conduct%5D`}>email</a>.
